  ...
  <div<?php print $content_attributes; ?>>
    ...
    <div class="branding-data clearfix">
      ...
      <hgroup class="site-name<?php print $class; ?>">        
        ...
        <?php if ($is_front): ?>        
        <h1 class="site-name<?php print $class; ?>"><a href="/"><span>www.</span><?php print $site_name; ?><span>.com</span></a></h1>
        <?php else: ?>
        <h2 class="site-name<?php print $class; ?>"><a href="/"><span>www.</span><?php print $site_name; ?><span>.com</span></a></h2>
        <?php endif; ?>
        <?php endif; ?>
        <?php if ($site_slogan): ?>
